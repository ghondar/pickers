...
export default [
  {
    ...
    onwarn,
    output: {
      file: 'build/dist/ghondar-pickers.js',
      format: 'cjs',
      sourcemap: true,
    },
...

  {
    ...
    onwarn,
    output: {
      file: 'build/dist/ghondar-pickers.esm.js',
      format: 'esm',
      sourcemap: true,
    },
    plugins: [
...

  {
    ...
    output: {
      ...
      format: 'umd',
      name: pkg.name,
      file: 'build/dist/ghondar-pickers.umd.js',
    },
    plugins: [
      nodeResolve({ extensions }),
      babel(getBabelOptions({ useESModules: true })),
...

  {
    ...
    output: {
      ...
      format: 'umd',
      name: pkg.name,
      file: 'build/dist/ghondar-pickers.umd.min.js',
    },
    plugins: [
      nodeResolve({ extensions }),
      babel(getBabelOptions({ useESModules: true })),

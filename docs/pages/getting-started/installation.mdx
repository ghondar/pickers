...
<PageMeta
  title="Installation"
  description="Step-by-step guide how to install @ghondar/pickers"
/>

## Installation

Available as an [npm package](https://www.npmjs.com/package/@ghondar/pickers)
...
@ghondar/pickers was designed to use the date management library of your choice.
